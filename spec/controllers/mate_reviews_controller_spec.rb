RSpec.describe MateReviewsController, type: :controller do
    ...
    describe "GET #show" do
        it "returns a success response" do
            ...
            get :show, params: {id: mate_review.to_param}, session: valid_session
    ...
    describe "POST #create" do
        context "with valid params" do
            it "creates a new mate review" do
                expect {
                post :create, params: {mate_review: valid_attributes}, session: valid_session
                }.to change(MateReview, :count).by(1)
            end
        ...
        context "with invalid params" do
            ...
            post :create, params: {mate_review: invalid_attributes}, session: valid_session
    ...
    describe "PUT #update" do
        context "with valid params" do
            it "updates the requested user" do
                mate_review = create(:mate_review)
                put :update, params: {id: mate_review.to_param, mate_review: {rating: 3.7}}, session: valid_session
                mate_review.reload
        ...
        context "with invalid params" do
            it "renders a JSON response with errors for the mate_review" do
                mate_review = create(:mate_review)
                put :update, params: {id: mate_review.to_param, mate_review: {user_id: nil}}, session: valid_session
                expect(response).to have_http_status(:unprocessable_entity)
                expect(response.content_type).to eq('application/json')
            end
        end
