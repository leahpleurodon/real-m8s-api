...
RSpec.describe BillPaymentsController, type: :controller do
    ...
    describe 'GET #show' do
        it 'returns a success response' do
            ...
            get :show, params: { id: bill_payment.to_param }, session: valid_session
    ...
    describe 'POST #create' do
        context 'with valid params' do
            ...
            expect do
                post :create, params: { bill_payment: valid_attributes }, session: valid_session
        ...
        context 'with invalid params' do
            ...
            post :create, params: { bill_payment: invalid_attributes }, session: valid_session
    ...
    describe 'PUT #update' do
        ...
        it 'updates the requested bill_payment' do
            bill_payment = create(:bill_payment)
            put :update, params: { id: bill_payment.to_param, bill_payment: { paid: true } }, session: valid_session
            bill_payment.reload
            expect(bill_payment.paid).to be true
        end
    
          it 'renders a JSON response with the bill_payment' do
                bill_payment = create(:bill_payment)
                put :update, params: { id: bill_payment.to_param, bill_payment: {
                paid: true
        ...
        context 'with invalid params' do
            it 'renders a JSON response with errors for the bill_payment' do
                bill_payment = create(:bill_payment)
                put :update, params: { id: bill_payment.to_param, bill_payment: { amount_due: 'very expensive' } }, session: valid_session
                expect(response).to have_http_status(:unprocessable_entity)
                expect(response.content_type).to eq('application/json')
            end
        end
