...
RSpec.describe HouseUsersController, type: :controller do
  ...
  describe 'GET #show' do
    it 'returns a success response' do
      ...
      get :show, params: { id: house_user.to_param }, session: valid_session
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new house_user' do
        expect do
          post :create, params: { house_user: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it 'renders a JSON response with errors for the new house_user' do
        post :create, params: { house_user: invalid_attributes }, session: valid_session
